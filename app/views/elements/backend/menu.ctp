...
<div id="menu">
    ...
    <div id="menu-button-backend" class="menu-button">
        <a class="menu-button-icon selectable" style="background-image: url(/img/backend/menu-button-backend.png)" href="/cms">
        </a>
    </div>
    ...
    <div id="menu-button-galleries" class="menu-button">
        <a class="menu-button-icon selectable" style="background-image: url(/img/backend/menu-button-galleries.png)" href="/cms/galleries">
        </a>
    </div>
