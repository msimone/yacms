...
<div id="menu">
    <div class="tab">
        <?=$html->link('', array('controller' => 'home', 'action' => 'index'), array('title' => __('Home', 1), 'class' => 'menu-button selectable home', 'style' => 'background-image: url(/img/backend/menu-button-home.png)'))?>
    </div>
    <div class="tab">
    ...
    <div class="tab">
        <?=$html->link('', array('controller' => 'resources', 'action' => 'index'), array('title' => __('Resources', 1), 'class' => 'menu-button selectable resources', 'style' => 'background-image: url(/img/backend/resources.png)'))?>
    </div>
    <div class="tab">
    ...
    <div class="tab">
        <?=$html->link('', array('controller' => 'users', 'action' => 'logout'), array('title' => __('Logout', 1), 'class' => 'menu-button users', 'style' => 'background-image: url(/img/backend/menu-button-logout.png)'), __('Are you sure you want to logout?', 1))?>
    </div>
</div>
<!--
